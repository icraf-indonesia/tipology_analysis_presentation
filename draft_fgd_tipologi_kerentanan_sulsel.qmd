...
pal <-
  leaflet::colorFactor(palette = "Set1", domain = clusters_sulsel_with_name$name)
...
intisari_desk_kec <- readr::read_csv("data/interpretasi_tipologi_sulsel_id.csv") |> 
  ...
  mutate(color_pal = c("#A65628","#984EA3","#377EB8","#E41A1C","#FF7F00",  "#4DAF4A", "black" ))
...
-   Kepadatan rumah tangga (penduduk) terendah kedua setelah tipologi perdesaan kaya kehati.
...
-   Laju kehilangan tutupan hutan (2015-2020) tertinggi setelah tipologi dominan ekonomi pertanian berbasis pohon. Paling dekat dengan lokasi bekas terbakar (2019).
...
-   Tutupan lahan dominan dengan kelas-kelas pertanian berbasis pohon.
...
-   Risiko erosi dan tanah longsor tertinggi kedua setelah daerah perdesaan kaya kehati
...
-   Aksesibilitas ke jalan dan sungai tergolong baik, kedua setelah tipologi dominan ekonomi industri dan jasa.

-   Kepadatan rumah tangga per kecamatan tertinggi kedua setelah tipologi dominan ekonomi industri dan jasa; pola serupa ada pada aksesibilitas terhadap fasilitas kesehatan dan pendidikan.
