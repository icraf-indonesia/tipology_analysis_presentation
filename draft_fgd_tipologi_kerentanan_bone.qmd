...
Kabupaten Bone, yang terletak di sisi timur Provinsi Sulawesi Selatan, memiliki luas wilayah sebesar 4,559 kilometer persegi. Kabupaten ini memiliki dataran rendah yang subur. Terdapat kawasan berbukit dan pegunungan di sisi barat, serta dialiri oleh sungai Walanae. Daerah ini menerima hujan sekitar 3000 mm/tahun, yang merupakan ciri khas iklim hutan hujan tropis.
...
Produk Domestik Bruto (PDB, Atas Dasar Harga Berlaku) untuk Kabupaten Bone adalah 43.64 triliun Rupiah Indonesia pada tahun 2022. Hal ini menempatkan Bone sebagai Kabupaten dengan perputaran ekonomi terbesar kedua di Sulawesi Selatan.
...
tabel_intisari <- readRDS("data/summary_table_bone.rds") |> 
...
centers <- clusters_bone_with_name |> sf::st_centroid( byid = TRUE)|> 
  mutate(x = unlist(map(geometry,1)),
    y = unlist(map(geometry,2)))
centers$region <- row.names(clusters_bone_with_name)
...
-   Separuh dari rumah tangga di tipologi ini berada dalam 40% kelompok ekonomi terbawah. Akses terhadap fasilitas pendidikan dan kesehatan yang terbatas.

-   Aksesibilitas terhadap penghidupan berbasis lahan paling terbatas dibandingkan tipologi lainnya di Bone.

### **2. Sentra Pertanian Berbasis Pohon/Perkebunan**

**Karakteristik**

-   Tipologi dengan luas 11.9% dari total luas daratan Kabupaten Bone & ditinggali oleh 8.4% rumah tangga.
...
-   Sekitar 4 dari 10 rumah tangga berada dalam 40% kelompok ekonomi terbawah.
...
-   Diperkirakan akan mengalami penurunan curah hujan tinggi (-130,57 mm) di antara tipologi lainnya. Dengan indeks kekeringan 0.13, menjadikannya paling rentan terhadap kekeringan.

-   Risiko banjir tinggi, terutama di musim hujan. Selain itu sisa tutupan pohon (termasuk hutan) yang relatif sedikit.

-   4 dari 10 Rumah Tangga di tipologi ini termasuk dalam 40% kelompok ekonomi terbawah.
...
-   Hanya 15,23% rumah tangga yang termasuk dalam 40% kelompok ekonomi terbawah.
...
-   Suhu saat ini paling hangat dibandingkan dengan daerah lain (27.13 °C); kenaikan suhu 1,41°C sangat mempengaruhi penduduk kurang mampu di lokasi ini.
